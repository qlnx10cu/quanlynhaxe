        ...
        <React.Fragment>
            ...
            <DivFlexRow style={{ marginTop: 10 }}>
                <DivFlexColumn>
                    ...
                    <Input readOnly autocomplete="off" value={utils.formatNgayGio(data.ngayban)} />
                </DivFlexColumn>
                <DivFlexColumn style={{ marginLeft: 20 }}>
                    <label>Ngày thanh toán: </label>
                    <Input readOnly value={utils.formatNgayGio(data.ngayban)} />
                </DivFlexColumn>
                <DivFlexColumn style={{ marginLeft: 20 }}>
            ...
            <DivFlexColumn style={{ marginTop: 10, alignItems: "right" }}>
                <label>
                    Tổng tiền:
                    <font size="4">
                        <b> {utils.formatVND(data.tongtien)}</b>
                    </font>
                </label>
            </DivFlexColumn>
            <DivFlexColumn style={{ marginTop: 10, alignItems: "right" }}>
